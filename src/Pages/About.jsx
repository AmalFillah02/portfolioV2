...
const AboutPage = () => {
  ...
  const { totalProjects, totalCertificates, YearExperience } = useMemo(() => {
    ...
    const startDate = new Date("2019-11-06");
  ...
  const statsData = useMemo(() => [
    {
      ...
      description: "Project inovatif yang telah saya kerjakan",
    ...
    },
    {
      ...
      label: "Certificates",
      description: "Sertifikat keterampilan profesional",
      animation: "fade-up",
    },
    {
      icon: Globe,
      ...
      label: "Tahun",
      description: "Pengalaman dalam pengembangan web",
      animation: "fade-left",
    },
    ...
    >
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
             Berbekal latar belakang Teknik Informatika, saya mengeksplorasi dunia Full-Stack Development untuk membangun aplikasi web yang tidak hanya menarik secara visual, tapi juga tangguh secara fungsional. Saya percaya, teknologi adalah jembatan antara ide dan solusi nyata.
            </p>
      ...
      >
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "Berpikir seperti seniman, membangun seperti insinyur."
        </blockquote>
      </div>
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              ...
              >
                <FileText className="w-4 h-4 sm:w-5 sm:h-5" /> Lihat CV
              </button>
              </a>
              ...
              >
                <Code className="w-4 h-4 sm:w-5 sm:h-5" /> Project Saya
              </button>
              </a>
            </div>
          </div>
