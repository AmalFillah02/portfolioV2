  ...
  <div className="space-y-2" data-aos="fade-up" data-aos-delay="600">
    <h1 className="text-5xl sm:text-6xl md:text-6xl lg:text-6xl xl:text-6xl font-bold tracking-tight">
      <span className="relative inline-block">
        <span className="absolute -inset-3 bg-gradient-to-r from-[#6366f1] to-[#a855f7] blur-2xl opacity-20"></span>
...
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/AmalFillah02/" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/ahsanul-amal-fillah/" },
  { icon: Instagram, link: "https://www.instagram.com/amalfillah_/" },
];
...
const Home = () => {
  ...
  const lottieOptions = {
    src: "https://lottie.host/11c54ec2-5451-46eb-92e2-c966bf031081/rN5S2hrU3S.lottie",
    loop: true,
    autoplay: true,
    rendererSettings: {
      ...
      >
        <div className="container mx-auto  min-h-screen ">
          <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
            ...
            <div
              className="w-full py-[10%] sm:py-0 lg:w-1/2 h-auto lg:h-[600px] xl:h-[750px] relative flex items-center justify-center order-2 lg:order-2 mt-20 sm:mt-28 md:mt-32 lg:mt-0"
