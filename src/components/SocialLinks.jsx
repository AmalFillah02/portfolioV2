...
const socialLinks = [
  {
    ...
    subText: "ke LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/ahsanul-amal-fillah/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@amalfillah_",
    icon: Instagram,
    url: "https://www.instagram.com/amalfillah_/",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@AmalFillah02",
    icon: Facebook,
    url: "#",
    color: "#4319ffff",
    gradient: "from-[#fff] to-[#4319ffff]",
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "AmalFillah02",
    icon: Github,
    url: "https://github.com/AmalFillah02/",
    color: "#ffffff",
  ...
  },
  {
    ...
    url: "https://tiktok.com/@amalfillahhh",
    color: "black",
...
const SocialLinks = () => {
  ...
  const [instagram, facebook, github, tiktok] = otherLinks;
